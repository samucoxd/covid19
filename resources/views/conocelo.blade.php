...
@section('titulo','Conocelo Covid-19')
@section('contenido')
...
<section class="page-section portfolio mt-4" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mt-4">Conocelo - Covid-19</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="{!! asset('assets/covid/esp_COVID_SM_know_02.png') !!}" alt="" />
                        </div>
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image--><img class="img-fluid rounded mb-5" src="{!! asset('assets/covid/esp_COVID_SM_know_02.png') !!}" alt="" /><!-- Portfolio Modal - Text-->
